...
`git clone https://github.com/NickAlvarez20/MatrixLibrary.git`


## Usage
Run the Go script from the command line:
1. go run main.go
2. On front-end run npm run dev - make sure you change api routes in api/books.go to localhost (https://localhost:{port}/books
